...
ITHit.DefineClass('ITHit.WebDAV.Client.Tests.HierarchyItems.CreateFolder', null, {}, /** @lends ITHit.WebDAV.Client.Tests.HierarchyItems.CreateFolder */{
     ...
     */
    CreateFolder: function(webDavSession, sFolderAbsolutePath, fCallback) {
...
QUnitRunner.test('Create folder and open it', function (test) {
    ...
    Helper.Create([
        ...
        QUnit.stop();
        ITHit.WebDAV.Client.Tests.HierarchyItems.CreateFolder.CreateFolder(webDavSession, Helper.GetAbsolutePath('HierarchyItems/'), function(oAsyncResult) {
            QUnit.start();
