...
QUnitRunner.test('Subscribe on WebDavSession events: OnBeforeRequestSend, OnResponse', function (test) {
    ...
    Helper.Create([
        ...
        webDavSession.OpenFileAsync(Helper.GetAbsolutePath('WebDavSession/event.txt'), null, function(oAsyncResult) {
            ...
            test.strictEqual(oRequestData.Headers['Content-Type'], 'text/xml; charset="utf-8"', 'Check content type header in request event data');
            ...
            test.strictEqual(oResponseData.Headers['Content-Type'], 'application/xml; charset=utf-8', 'Check content type header in response event data');
